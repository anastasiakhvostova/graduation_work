  ...
  return (
    ...
    >
      <div className="max-w-[1140px] h-full mx-auto flex items-center justify-between px-6 lg:px-10">
        {status === "correct" && (
          <div
            className="text-green-500 font-extrabold text-xl lg:text-3xl flex items-center"
          >
        ...
        {status === "wrong" && (
          <div
            className="text-rose-500 font-extrabold text-xl lg:text-3xl flex items-center"
          >
